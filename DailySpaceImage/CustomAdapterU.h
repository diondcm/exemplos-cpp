...
private:
	...
	class TBitmapString : public TBitmap
	{
	private:
        String FImgName;
	public:
		__property String ImgName = {read=FImgName, write=FImgName};
	};

	friend class TBitmapString;
...
private:
	...
	std::map<int, TBitmapString*>FBitmaps;
	...
	// don't use void* on production, this is only in correction os a bug
	// keep looking at this repository on GitHub, ASAP the correct solution w'll be available
	std::vector<void*>FThreads;
